...
const ToClientCommandHandler toClientCommandTable[TOCLIENT_NUM_MSG_TYPES] =
{
	...
	{ "TOCLIENT_BROWSER_ADDRESS",	       TOCLIENT_STATE_CONNECTED, &Client::handleCommand_SetBrowserAddress }, // 0x54
	{ "TOCLIENT_SPEAK_TEXT"				 , TOCLIENT_STATE_CONNECTED, &Client::handleCommand_SpeakText }, // 0x55,
	null_command_handler,
	null_command_handler,
	null_command_handler,
	null_command_handler,
